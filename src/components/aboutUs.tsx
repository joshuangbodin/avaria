...
const AboutUs = ({}: Props) => {
  return (
    <div className=" w-full h-[500px] justify-center items-center  bg-amber-950 flex px-20  text-white">
      ...
      <div className="flex text-sm md:text-md flex-col  items-center justify-center md:w-2/5   p-6 h-auto font-sedan ">
        <h4 className="flex font-cinzel capitalize text-lg md:text-2xl lg:text-4xl font-bold self-start mb-4">
