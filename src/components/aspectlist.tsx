...
const AspectList = ({}: Props) => {
  return (
    <div className="flex relative h-[60vh]  gap-2 flex-wrap  justify-center items-center">
      ...
      <div className=" w-4/6 p-3 font-sedan text-white">
      <h3 className=" text-center font-cinzel mb-12 font-bold text-lg md:text-2xl flex flex-col md:justify-center md:items-center">Testimonials</h3>
